...
<div class="summary"><div class="sum" data-action="summaryDetail" data-kind="income"><label>Gelir</label><strong style="color:var(--green)">${money(T.i)}</strong></div><div class="sum" data-action="summaryDetail" data-kind="expense"><label>Gider</label><strong style="color:var(--red)">${money(T.e)}</strong></div><div class="sum" data-action="summaryDetail" data-kind="remain"><label>Kalan</label><strong style="color:var(--gr)">${money(T.r)}</strong></div></div>
<div class="section cleanHomeTitle"><b>HIZLI İŞLEMLER</b><span></span></div><div class="card quick premiumQuick v1947Quick cleanQuick"><button data-action="addIncome"><i class="qIncome">${premiumIcon("income",27)}</i>GELİR EKLE</button><button data-action="addExpense"><i class="qExpense">${premiumIcon("expense",27)}</i>GİDER EKLE</button><button data-tab="monthPaid"><i class="qCard">${premiumIcon("cards",27)}</i>AYLIK HESAP</button><button data-tab="calendar"><i class="qCalendar">${premiumIcon("fixed",27)}</i>TAKVİM</button><button data-tab="reports"><i class="qReport">${premiumIcon("report",27)}</i>RAPORLAR</button></div>
