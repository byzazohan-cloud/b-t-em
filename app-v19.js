...
function categoryIconSvg(cat,size=30){
  ...
  if(fixed3d[k])return `<img class="cat3dAsset" src="icons/fixed3d_v124/${fixed3d[k]}.png?v=V125" width="${size}" height="${size}" alt="" aria-hidden="true">`;
...
const HANE_SW_BUILD='19.4.8.20260921-V125-ICON-SCALE';
