...
function haneLogo(size=54,cls=''){
  ...
  return `<svg class="haneLogo ${cls}" width="${n}" height="${n}" viewBox="0 0 100 100" aria-label="HANE">
    <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" stroke-width="4"/>
    <path d="M25 48 L50 27 L75 48" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M31 45 V72 H69 V45" fill="none" stroke="currentColor" stroke-width="5" stroke-linejoin="round"/>
    <circle cx="43" cy="53" r="6" fill="currentColor"/>
    <circle cx="58" cy="53" r="6" fill="currentColor"/>
    <path d="M34 69c2-10 8-15 16-15s14 5 16 15" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>
  </svg>`;
}
...
function buildTopBar(){
  if(current==='home')return`<div class="top homeTop"><div class="topSpacer"></div><div class="brand brandLogo">${haneLogo(30,'brandMark')}<span>HANE</span></div><button class="ib" data-tab="profile">⚙</button></div>`;
...
function about(){return`<div class="profile"><div class="logoSvgWrap">${haneLogo(84)}</div><h1 style="color:var(--gold2)">HANE</h1><p>SÜRÜM 1.9.0</p><p>PREMİUM EV BÜTÇEN.<br>VERİLERİN CİHAZINDA ŞİFRELİ SAKLANIR.</p></div>`}
