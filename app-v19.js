...
function categoryIconSvg(cat,size=30){
  ...
  if(fixed3d[k])return `<img class="cat3dAsset" src="icons/categories3d/${fixed3d[k]}.png?v=V120" width="${size}" height="${size}" alt="" aria-hidden="true">`;
