...
function category3dAsset(cat){
  ...
  if(fixed[k])return `icons/fixed3d_v124/${fixed[k]}.png?v=V134`;
  const normal={
  ...
  return `icons/normal3d_v124/${normal[k]||'diger'}.png?v=V134`;
}
