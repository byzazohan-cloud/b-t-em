...
function haneLogo(size=54,cls=''){
  ...
  return `<img class="haneLogoImg ${cls}" src="icons/hane-app-icon.png?v=1948brand8" width="${n}" alt="HANE">`;
}
function haneFullLogo(cls=''){
  return `<img class="haneFullLogo ${cls}" src="icons/hane-app-icon.png?v=1948brand8" alt="HANE">`;
}
...
const HANE_SW_BUILD='19.4.8.20260920-LOCAL-DATA-ONLY-48-Z-AUDIT-FIX';
const HANE_SW_URL='./sw.js?v='+encodeURIComponent(HANE_SW_BUILD);
const HANE_ENGINE_CACHE='hane-v19-4-8-LOCAL-DATA-ONLY-48-Z-AUDIT-FIX';
