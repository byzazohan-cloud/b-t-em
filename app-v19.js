...
function stmtMatchSelect(row,i){
  ...
  const detail=(status==='matched'?'Mevcut HANE kaydı bulundu':status==='possible'?'Kullanıcı onayı gerekli':'HANE’de eşleşen kayıt bulunamadı')+(row.matchReason?' · '+row.matchReason:'');
...
const HANE_SW_BUILD='20260923-V113-S18-FIX1';
const HANE_SW_URL='./sw.js?v='+encodeURIComponent(HANE_SW_BUILD);
const HANE_ENGINE_CACHE='hane-engine-19.4.25-V113-S18-FIX1';
