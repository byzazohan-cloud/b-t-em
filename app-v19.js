...
function haneLogo(size=54,cls=''){
  ...
  return `<img class="haneLogoImg ${cls}" src="icons/hane-app-icon.png?v=1948brand7" width="${n}" alt="HANE">`;
}
function haneFullLogo(cls=''){
  return `<img class="haneFullLogo ${cls}" src="icons/hane-app-icon.png?v=1948brand7" alt="HANE">`;
}
...
const HANE_SW_BUILD='19.4.8.20260920-LOCAL-DATA-ONLY-47-Z-ICON-SYSTEM';
