...
function haneLogo(size=54,cls=''){
  ...
  return `<img class="haneLogoImg ${cls}" src="icons/hane-app-icon.png?v=1948g8" width="${n}" alt="HANE">`;
}
function haneFullLogo(cls=''){
  return `<img class="haneFullLogo ${cls}" src="icons/hane-app-icon.png?v=1948g8" alt="HANE">`;
}
...
function about(){return`<div class="profile"><div class="aboutV5Logo">${haneFullLogo("aboutV5")}</div><p>SÜRÜM 19.4.8 · CLEAN FINAL</p><p>PREMİUM EV BÜTÇEN.<br>VERİLERİN CİHAZINDA ŞİFRELİ SAKLANIR.</p></div>`}
