...
const C=['Kira','Aidat','Market','Manav','Fırın','Harçlık','Yemek','Restoran','Giyim','Akaryakıt','Ulaşım','Sağlık','Eğitim','Ev','Temizlik','Çocuk','Evcil Hayvan','Kişisel Bakım','Abonelik','Eğlence','Tatil','Hediye','Sigorta','Vergi','Faturalar','İnternet','Elektrik','Su','Doğalgaz','Cep Telefonu','Diğer'];
const NORMAL_C=['Market','Manav','Fırın','Harçlık','Yemek','Restoran','Giyim','Akaryakıt','Ulaşım','Sağlık','Eğitim','Ev','Temizlik','Çocuk','Evcil Hayvan','Kişisel Bakım','Abonelik','Eğlence','Tatil','Hediye','Sigorta','Vergi','Diğer'];
...
function applyTheme(){if(!state)return;const t=state.theme||{},dark=state.settings?.darkMode!==false;document.documentElement.classList.toggle('lightMode',!dark);document.documentElement.style.setProperty('--bg',dark?(t.bg||'#000'):'#f3f1eb');document.documentElement.style.setProperty('--gold',t.accent||'#d8ad4f');document.documentElement.style.setProperty('--gold2',t.accent||'#f0cd77');document.documentElement.style.setProperty('--gi',t.income||'#248ef5');document.documentElement.style.setProperty('--ge',t.expense||'#ff4658');document.documentElement.style.setProperty('--gr',t.remain||'#16d77d')}
