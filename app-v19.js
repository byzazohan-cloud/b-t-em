...
function category3dAsset(cat){
  ...
  if(fixed[k])return `icons/fixed3d_v124/${fixed[k]}.png?v=V129`;
  const normal={
  ...
  return `icons/normal3d_v124/${normal[k]||'diger'}.png?v=V129`;
}
...
function haneLogo(size=54,cls=''){
  ...
  return `<img class="haneLogoImg ${cls}" src="icons/hane-main-logo-v126.png?v=V129" width="${n}" alt="HANE">`;
}
function haneFullLogo(cls=''){
  return `<img class="haneFullLogo ${cls}" src="icons/hane-main-logo-v126.png?v=V129" alt="HANE">`;
}
function premiumIcon(name,size=26){
  ...
  return `<img class="system3dIconV127" src="icons/system3d_v127/${k}.png?v=V129" alt="" style="width:${size}px;height:${size}px" aria-hidden="true">`;
}
...
const HANE_SW_BUILD='19.4.8.20260921-V129-AUDIT-FIX';
