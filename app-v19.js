...
function financeMonthSnapshot(m=state.selectedMonth){
  ...
  const byCategory={};expenses.forEach(x=>{const k=x.category||'Diğer';byCategory[k]=(byCategory[k]||0)+(+x.amount||0)});
