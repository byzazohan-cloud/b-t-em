...
function expenseForm(x={}){
  ...
  return`<form class="form" id="expenseForm">
    ...
    <div class="notice" id="expenseHelp">
      ${isFixed?'SABİT GİDERDE SADECE SON ÖDEME TARİHİ KULLANILIR.':'NORMAL GİDERDE SADECE HARCAMA TARİHİ KULLANILIR.'}
    </div>
...
function bind(){
  ...
  if(expenseTypeEl) expenseTypeEl.onchange=e=>{
    ...
    if(help)help.textContent=fixed?'SABİT GİDERDE SADECE SON ÖDEME TARİHİ KULLANILIR.':'NORMAL GİDERDE SADECE HARCAMA TARİHİ KULLANILIR.';
  };
