...
## V19.4.8 — Grup 1 Finansal Çekirdek
- Sabit giderlerde fatura tutarı ile gerçek ödenen tutar ayrıldı.
- Gider toplamlarında sabit gider için gerçek ödeme kaydı esas alınır.
- Kart borcu artık ana gider + sabit ödeme + kart ödeme kayıtlarından merkezi olarak yeniden hesaplanır.
- Kart ödemesi düzenleme/silme sonrası borç otomatik düzelir.
- Kart hareketleri ana gider/ödeme kayıtlarından türetilir; bağımsız kopya sapması azaltılır.
- Eski 19.4.8 verileri korunur; ilk geçişte mevcut kart borcu açılış bakiyesiyle sabitlenir.
- Normal giderlerde mevcut tutar gerçek harcama olarak korunur.
